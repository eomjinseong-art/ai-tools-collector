...
insert into categories (slug, name, description, search_keywords, is_trend, sort_order) values
  ...
  ('capcut',      '캡컷',        'AI 영상 편집 앱',                             array['캡컷 사용법','캡컷 편집 강의','캡컷 AI 기능'], false, 11),
  ('vrew',        '브루',        'AI 자동 자막·영상 편집 툴',                   array['브루 사용법','Vrew 사용법','브루 편집 강의'], false, 12),
  ('suno',        '수노',        'AI 음악 생성',                                array['수노 사용법','Suno AI 노래 만들기','수노 AI 활용'], false, 13),
  ('elevenlabs',  '일레븐랩스',  'AI 음성 합성·더빙',                           array['일레븐랩스 사용법','ElevenLabs 활용','일레븐랩스 AI 음성'], false, 14),
  ('heygen',      '헤이젠',      'AI 아바타 영상 생성',                         array['헤이젠 사용법','HeyGen 활용','헤이젠 AI 아바타'], false, 15),
  ('notion-ai',   '노션AI',      '노션의 AI 글쓰기·정리 기능',                  array['노션 AI 사용법','Notion AI 활용','노션AI 활용법'], false, 16),
  ('figma',       '피그마',      'AI 기능이 포함된 디자인 협업 툴',             array['피그마 사용법','Figma AI 기능','피그마 강의'], false, 17),
  ('gamma',       '감마',        'AI 프레젠테이션·문서 생성',                   array['감마 사용법','Gamma AI 발표자료','감마 앱 활용'], false, 18),
